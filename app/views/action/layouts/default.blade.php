            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-dollar"></i> Budgeting <span class="fa fa-chevron-down"></span></a>
              ...
              <ul class="nav side-menu">
                  <li><a><i class="fa fa-money"></i>Revenues <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
			  ...
			  <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-key"></i> Settings <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a href="{{URL::to('emoluments/index')}}">P E References</a></li>
                   <li><a href="{{URL::to('pe_remarks/index')}}">P E Remarks</a></li>
