                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-green">
                                            ...
                                            <div class="panel-body pan">
                                                <form action="{{URL::to('revenueCategory/update/'.$item->id)}}" method="post">
                                                        ...
                                                        {{--<div class="col-md-2">--}}
                                                            ...
                                                            {{--<label>Item Code</label>--}}
                                                                {{--<div class="input-icon">--}}
                                                                    {{--<input  type="text"  value="{{$item->item_code}}" name="item_code" class="form-control" /></div>--}}
                                                        ...
                                                        {{--</div>--}}
                                                         <div class="col-md-6">
                                                            ...
                                                            <label>Description of Revenue</label>
                                                                <div class="input-icon">
                                                                    <input  type="text" value="{{$item->name}}" name="name" class="form-control" /></div>
