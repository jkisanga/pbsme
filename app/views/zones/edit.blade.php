                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-green">
                                            ...
                                            <div class="panel-body pan">
                                                <form action="{{URL::to('zones/update/'. $zone->id)}}" method="post">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <label>Station Name</label>
                                                                <div class="input-icon">
                                                                    <input  type="text" value="{{$zone->zone_name}}" name="zone_name" class="form-control" /></div>
                                                         ...
                                                         <div class="col-md-3">
                                                            ...
                                                            <label>Acronym</label>
                                                                <div class="input-icon">
                                                                    <input  type="text" value="{{$zone->short_name}}" name="short_name" class="form-control" /></div>
