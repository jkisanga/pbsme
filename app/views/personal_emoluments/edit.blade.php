    ...
    <div class="col-lg-12">
        <div class="panel panel-green">
            ...
            <div class="panel-body pan">
                <form action="{{URL::to('personal_emoluments/update/'.$post->id)}}" method="post">
...
<div class="box-body">
                  ...
                  @endforeach
                    ...
                    <input type="text" name="code_no" class="form-control " id="code_no"  readonly="true" value="{{$post->code_no}}" />
                     <script>
                    ...
                    <input type="text" name="salary_scale" class="form-control" id="salary_scale" readonly="true" value="{{$post->salary_scale}}" />
                     <script>
                     $('#designation').change(function() {
                                var code = $(this).children(":selected").attr("id");
                                var split = code.split(",");
                  ...
                  <div class="col-xs-4"><label>ESTABLISHED MANNING LEVEL <br>{{$financial_year->year}}/{{$financial_year->year+1}}</label>
                    <input type="text" class="form-control" name="established_meaning_level" value="{{$post->established_meaning_level}}">
                  ...
                  <div class="col-xs-4"><label>ACTUAL STRENGTH<br> {{$financial_year->year-1}}/{{$financial_year->year}}</label>
                    <input type="text" class="form-control" name="actual_strength" value="{{$post->actual_strength}}">
                  ...
                  <div class="col-xs-4"><label>APPROVED ESTABLISHMENT<br> {{$financial_year->year-1}}/{{$financial_year->year}}</label>
                    <input type="text" class="form-control" name="approved_establishment" value="{{$post->approved_establishment}}">
...
<br /><br>
                  ...
                  <div class="col-xs-4"><label>APPROVED ESTIMATES <br>{{$financial_year->year-1}}/{{$financial_year->year}}</label>
                    <input type="text" class="form-control" name="approved_estimate" value="{{$post->approved_estimate}}">
                  ...
                  <div class="col-xs-4"><label>APPROVED ESTABLISHMENT<br> {{$financial_year->year}}/{{$financial_year->year+1}}</label>
                    <input type="text" class="form-control" name="approved_establishment_next" value="{{$post->approved_establishment_next}}">
                  ...
                  <div class="col-xs-4"><label>APPROVED ESTIMATES<br> {{$financial_year->year+1}}/{{$financial_year->year+2}}</label>
                    <input type="text" class="form-control" name="approved_estimate_next" value="{{$post->approved_estimate_next}}">
